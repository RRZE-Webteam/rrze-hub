...
CREATE OR REPLACE VIEW getLecture AS 
    SELECT 
        ...
        lec.sLiterature AS literature,
        lec.sEctssummary AS ects_summary,
        lec.sEctsliterature AS ects_literature,
        lec.sEctsorganizational AS ects_organizational,
        lec.sKeywords AS keywords,     
